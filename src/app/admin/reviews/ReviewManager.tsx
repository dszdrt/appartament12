...
import { Star, Eye, EyeOff, Pin, Trash2, Plus, Edit2, Check, X } from "lucide-react";
    ...
    <div>
      <div className="flex justify-end mb-6">
        <button
          ...
          className="btn-gold text-xs py-2.5 px-5 flex items-center gap-2 rounded-xl"
        >
          ...
          >
            ...
            <div className="flex items-center justify-between gap-2 mb-4">
              ...
              <div className="flex items-center gap-1">
                <button
                  onClick={async () => await toggleReviewPin(rev.id, !rev.isPinned)}
                ...
                <button
                  onClick={async () => await toggleReviewVisibility(rev.id, !rev.isVisible)}
                  className={`p-2 rounded-lg transition-colors ${
                    rev.isVisible
            ...
            {/* Text */}
            <p className="text-warm-white/70 text-sm leading-relaxed whitespace-pre-line">
              "{rev.text}"
            </p>
          </div>
        ))}
            ...
            >
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-white/10">
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="btn-gold text-xs py-2.5 px-6 rounded-xl"
                >
